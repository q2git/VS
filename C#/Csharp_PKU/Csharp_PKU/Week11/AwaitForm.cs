...
namespace Csharp_PKU.Week11
{
    public partial class AwaitForm : Form
    {
        ...
        {
            textBox3.Text = $"BeforeGet: {Thread.CurrentThread.ManagedThreadId}";
            this.textBox2.Text = "";
            string url = textBox1.Text.Trim();
            string content = await AccessTheWebAsync(url);
            this.textBox2.Text = content.Length.ToString();
            textBox3.Text = $"AfterGet: {Thread.CurrentThread.ManagedThreadId}";
